...
const TICKER_SYMBOLS = [
  ...
  { symbol: "SPY", label: "S&P 500", mult: 10.3 },
  { symbol: "DIA", label: "DJIA", mult: 119 },
  { symbol: "QQQ", label: "NASDAQ", mult: 38.4 },
  { symbol: "IWM", label: "Russell 2000", mult: 12.8 },
...
const DEFAULT_INDICES = [
  { symbol: "S&P 500", value: 6932.30, change: 0.43 },
  { symbol: "DJIA", value: 50115.67, change: -0.25 },
  { symbol: "NASDAQ", value: 23031.21, change: 0.75 },
  { symbol: "Russell 2000", value: 2670.34, change: 0.55 },
  { symbol: "Gold", value: 4979.80, change: 0.64 },
  { symbol: "Crude Oil", value: 100.16, change: -1.29 },
  { symbol: "Silver", value: 84.52, change: 1.12 },
...
const UNSUPPORTED_TICKERS = new Set(["IBIT", "GBTC", "ETHE", "BITO", "ARKB", "FBTC", "BITB", "EZBC", "HODL", "BTCO", "DEFI", "BTCW", "RNDR", "RENDER", "X"]);
...
const fetchRealQuotes = async (holdings) => {
  ...
  // Remove Binance-primary symbols from needFetch so Finnhub cannot overwrite with stale data
