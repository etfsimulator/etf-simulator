  ...
  return (
    <div className="page-container" style={{ maxWidth: 1060, margin: "0 auto", padding: "48px 20px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14, marginBottom: 52, textAlign: "center" }}>
        {[
          { n: "10,000+", l: "US Stocks & ETFs" }, { n: "64+", l: "Crypto Assets" }, { n: "$1M", l: "Simulated Capital" }, { n: "Live", l: "Finnhub Market Data" },
        ].map((s) => (
    ...
    <div className="builder-container" style={{ maxWidth: 880, margin: "0 auto", padding: "36px 20px" }}>
      ...
      <div style={{ ...cardS(), marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 4, flexWrap: "wrap", gap: 8 }}>
          ...
          {loading && genStep > 0 && (() => {
            const steps = [
              { n: 1, l: "Analyzing thesis" },
              { n: 2, l: "Selecting holdings" },
              { n: 3, l: "Fetching live prices" },
              { n: 4, l: "Calculating positions" },
              { n: 5, l: "Done ✓" },
            ];
            return (
                ...
                {steps.map(s => {
                  ...
                  return (
                    <div key={s.n} style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      ...
                      <span style={{ fontSize: 10.5, color: active ? C.accentLight : done ? C.green : C.dim, fontFamily: mono, transition: "color .3s" }}>{s.l}</span>
                      {s.n < 5 && <span style={{ color: C.border, fontSize: 10 }}>›</span>}
                    </div>
                  );
                })}
              </div>
