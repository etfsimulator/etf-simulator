...
const PRICE_CAPS = {
  ...
  // ── Commodity ETFs — caps updated March 2026 (gold at $4,979/oz, silver at $84/oz) ──
  ...
  "GDX": 90,    // real ~$52 (VanEck gold miners)
  "GDXJ": 80,   // real ~$44 (junior gold miners)
...
const COMMODITY_ETF_KNOWN_PRICES = {
  "GLD": 472,   // Gold ETF: $4,979/oz ÷ 10.55 = $472
  "IAU": 47.2,  // iShares Gold: $4,979/oz ÷ 105.5 = $47.2
  "SLV": 77.8,  // Silver ETF: $84/oz ÷ 1.08 = $77.8
  "USO": 104.2, // US Oil Fund: $100/bbl ÷ 0.96 = $104.2
  "UNG": 15.0, "WEAT": 6.0, "CORN": 22.0,
  "GDX": 52.0, "GDXJ": 44.0, "URA": 30.0,
...
const COMMODITY_ETF_MIN_PRICES = {
  "GLD": 350, "IAU": 35, "SLV": 55, "USO": 70, "GDX": 30, "GDXJ": 22,
};
