        ...
        const loadPortfolios = async (attempt = 1) => {
          try {
            ...
            if (data && data.length > 0) {
              ...
              // Migration complete — RNDR→LINK swap already persisted to Supabase on prior deploy.
              // No further migrations needed. Live pricing engines handle everything from here.
            } else {
              setPortfolios([]);
            }
          } catch (err) {
