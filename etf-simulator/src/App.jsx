...
function Leaderboard({ publicPortfolios, user, lbLoading }) {
...
function AppInner() {
  ...
  useEffect(() => {
    ...
    const pricePubs = async () => {
      if (dead) return;
      if (Date.now() - pubUpdateThrottle.current < 20000) return;
  ...
  const pages = {
    ...
    leaderboard: <Leaderboard publicPortfolios={allPublicPortfolios} user={user} lbLoading={lbLoading} />,
    learn: <Learn />,
