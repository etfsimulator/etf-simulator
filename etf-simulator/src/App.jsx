      ...
      {buildMode === "manual" && !portfolio && (
        <div style={{ ...cardS(), marginBottom: 20 }}>
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "60px 1fr 52px 55px 80px 28px", gap: 6, padding: "6px 0", borderBottom: `1px solid ${C.border}`, fontSize: 9, color: C.dim, fontFamily: mono }}>
              <span>TICKER</span><span>NAME</span><span>TYPE</span><span>WEIGHT</span><span>AMOUNT</span><span></span>
            </div>
            {manualHoldings.map((h, i) => (
              <div key={i} style={{ display: "grid", gridTemplateColumns: "60px 1fr 52px 55px 80px 28px", gap: 6, padding: "6px 0", borderBottom: `1px solid ${C.border}`, alignItems: "center" }}>
